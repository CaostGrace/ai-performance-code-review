...
- 将 Skill 落地为**多文件结构**：1 个 SKILL.md 入口 + 14 个按维度拆分的规则文件 + 1 个工具速查卡文件（`references/tools.md`）
...
### New Capabilities
- `skill-file-structure`: Skill 多文件组织与路由入口（SKILL.md + rules/*.md + references/tools.md）
...
- **Skill 文件**: 新建 `android-performance-cr/` 目录，包含 SKILL.md + 14 个 rules/*.md + references/tools.md
